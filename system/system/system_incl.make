...
# Project:C:\Users\runarbol\Documents\GitHub\tdt4255\system\system\system.xmp
#
...
APP_COMMUNICATION_OUTPUT_DIR = App_Communication
APP_COMMUNICATION_OUTPUT = $(APP_COMMUNICATION_OUTPUT_DIR)/executable.elf
CYG_APP_COMMUNICATION_OUTPUT_DIR = App_Communication
CYG_APP_COMMUNICATION_OUTPUT = $(CYG_APP_COMMUNICATION_OUTPUT_DIR)/executable.elf
...
BRAMINIT_ELF_FILES =  $(CYG_APP_COMMUNICATION_OUTPUT) 
BRAMINIT_ELF_FILE_ARGS =   -pe microblaze_0 $(APP_COMMUNICATION_OUTPUT) 

ALL_USER_ELF_FILES = $(CYG_TESTAPP_MEMORY_MICROBLAZE_0_OUTPUT) $(CYG_TESTAPP_PERIPHERAL_MICROBLAZE_0_OUTPUT) $(CYG_APP_COMMUNICATION_OUTPUT) 
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(LANGUAGE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_FILE_ARGS) $(MIX_LANG_SIM_OPT) -msg __xps/ise/xmsgprops.lst -s mti -X C:/Users/runarbol/Documents/GitHub/tdt4255/system/system/
...
implementation/mips_pipelined_0_wrapper.ngc
...
APP_COMMUNICATION_SOURCES = App_Communication/src/main.c 

APP_COMMUNICATION_HEADERS = drivers/mips_pipelined_v1_00_a/src/mips_pipelined.h 

APP_COMMUNICATION_CC = mb-gcc
APP_COMMUNICATION_CC_SIZE = mb-size
APP_COMMUNICATION_CC_OPT = -O2
APP_COMMUNICATION_CFLAGS = 
APP_COMMUNICATION_CC_SEARCH = # -B
APP_COMMUNICATION_LIBPATH = -L./microblaze_0/lib/ # -L
APP_COMMUNICATION_INCLUDES = -I./microblaze_0/include/  -Idrivers/mips_pipelined_v1_00_a/src/ # -I
APP_COMMUNICATION_LFLAGS = # -l
APP_COMMUNICATION_LINKER_SCRIPT = App_Communication/App_Communication_linker_script.ld
APP_COMMUNICATION_LINKER_SCRIPT_FLAG = -T $(APP_COMMUNICATION_LINKER_SCRIPT) 
APP_COMMUNICATION_CC_DEBUG_FLAG =  -g 
APP_COMMUNICATION_CC_PROFILE_FLAG = # -pg
APP_COMMUNICATION_CC_GLOBPTR_FLAG= # -mxl-gp-opt
APP_COMMUNICATION_MODE = executable
APP_COMMUNICATION_LIBG_OPT = -$(APP_COMMUNICATION_MODE) microblaze_0
APP_COMMUNICATION_CC_INFERRED_FLAGS= -mno-xl-soft-mul -mxl-barrel-shift -mxl-pattern-compare -mcpu=v8.00.b 
APP_COMMUNICATION_CC_START_ADDR_FLAG=  #  # -Wl,-defsym -Wl,_TEXT_START_ADDR=
APP_COMMUNICATION_CC_STACK_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_STACK_SIZE=
APP_COMMUNICATION_CC_HEAP_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_HEAP_SIZE=
APP_COMMUNICATION_OTHER_CC_FLAGS= $(APP_COMMUNICATION_CC_GLOBPTR_FLAG)  \
                  $(APP_COMMUNICATION_CC_START_ADDR_FLAG) $(APP_COMMUNICATION_CC_STACK_SIZE_FLAG) $(APP_COMMUNICATION_CC_HEAP_SIZE_FLAG)  \
                  $(APP_COMMUNICATION_CC_INFERRED_FLAGS)  \
                  $(APP_COMMUNICATION_LINKER_SCRIPT_FLAG) $(APP_COMMUNICATION_CC_DEBUG_FLAG) $(APP_COMMUNICATION_CC_PROFILE_FLAG) 
