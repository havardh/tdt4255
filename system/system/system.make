...
# C:\Users\runarbol\Desktop\tdt4255-new\system\system\system.mhs
# The software specification of the system is in file :
# C:\Users\runarbol\Desktop\tdt4255-new\system\system\system.mss
...
communication_program: $(CYG_COMMUNICATION_OUTPUT) 

$(CYG_COMMUNICATION_OUTPUT) : $(COMMUNICATION_SOURCES) $(COMMUNICATION_HEADERS) $(COMMUNICATION_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/communication_compiler.opt
	@mkdir -p $(COMMUNICATION_OUTPUT_DIR) 
	$(COMMUNICATION_CC) $(COMMUNICATION_CC_OPT) $(COMMUNICATION_SOURCES) -o $(CYG_COMMUNICATION_OUTPUT) \
	$(COMMUNICATION_OTHER_CC_FLAGS) $(COMMUNICATION_INCLUDES) $(COMMUNICATION_LIBPATH) \
	$(COMMUNICATION_CFLAGS) $(COMMUNICATION_LFLAGS) 
	$(COMMUNICATION_CC_SIZE) $(CYG_COMMUNICATION_OUTPUT) 
	@echo ""

communication_programclean:
	rm -f $(COMMUNICATION_OUTPUT) 
