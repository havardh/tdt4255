/*****************************************************************************
* Filename:          C:\Users\runarbol\Desktop\tdt4255-new\system\system/drivers/mips_kult_v1_00_a/src/mips_kult_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the mips_kult driver
...
XStatus MIPS_KULT_SelfTest(void * baseaddr_p)
{
  ...
  MIPS_KULT_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MIPS_KULT_mReadSlaveReg0(baseaddr, 0);
  ...
  MIPS_KULT_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = MIPS_KULT_mReadSlaveReg1(baseaddr, 0);
  ...
  MIPS_KULT_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = MIPS_KULT_mReadSlaveReg2(baseaddr, 0);
  ...
  MIPS_KULT_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = MIPS_KULT_mReadSlaveReg3(baseaddr, 0);
  ...
  MIPS_KULT_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = MIPS_KULT_mReadSlaveReg4(baseaddr, 0);
