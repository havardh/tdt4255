...
XStatus MIPS_MULTI_CYCLE_SelfTest(void * baseaddr_p)
{
  ...
  MIPS_MULTI_CYCLE_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MIPS_MULTI_CYCLE_mReadSlaveReg0(baseaddr, 0);
  ...
  MIPS_MULTI_CYCLE_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = MIPS_MULTI_CYCLE_mReadSlaveReg1(baseaddr, 0);
  ...
  MIPS_MULTI_CYCLE_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = MIPS_MULTI_CYCLE_mReadSlaveReg2(baseaddr, 0);
  ...
  MIPS_MULTI_CYCLE_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = MIPS_MULTI_CYCLE_mReadSlaveReg3(baseaddr, 0);
  ...
  MIPS_MULTI_CYCLE_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = MIPS_MULTI_CYCLE_mReadSlaveReg4(baseaddr, 0);
